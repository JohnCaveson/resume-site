      ...
      <div className="container">
        <div className="hero-content">
          ...
          <div className="hero-links">
            ...
            <a href={resume.github} target="_blank" rel="noopener noreferrer" className="hero-link" aria-label="GitHub">
            ...
            <a href={resume.website} target="_blank" rel="noopener noreferrer" className="hero-link" aria-label="Website">
